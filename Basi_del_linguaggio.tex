...
%TODO: constexpr if, constexpr function 

%TODO: spiegare cos'è il main e a cosa serve (oppure in realtà ce l'ho già)

%TODO: magari aggiungere una section dopo i tipi di variabili, con le keywords e un'immagine con tutte le keywords del C++.

%TODO: importanza di scrivere la f nei float. esempio:
%TODO: float x; float y = x * 2.0; se non mettiamo la f a quel 2.0, verrà promosso a double, perché 2.0 è un double. quindi -> float y = x * 2.0f;

%TODO: valori di default nei parametri nelle funzioni.
