...
%TODO: Dependency Injection
%TODO: pointer to a function
%TODO: Tecniche per debuggare codice
%TODO: C++ Competitive Programming e clean code.
%TODO: Scrivere codice efficiente.
...
%TODO: uncomment quando avrò aggiunto l'immagine.
\begin{comment}
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth, height=1\textheight, keepaspectratio]{./imgs/.png}
	\caption{Unique ptr}
	\label{fig:}
\end{figure}
\end{comment}
