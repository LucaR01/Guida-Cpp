...
\newpage %TODO: questo newpage mi serve perché altrimenti si scombina tutto e vengono fuori troppi spazi bianchi.
...
\subsection{Pure Virtual Destructor} %TODO: o qui o dopo la subsection Abstract Class
...
\textsf{\small Gli errori a \textbf{runtime} sono quegli errori che occorrono durante l'esecuzione del programma dopo che la compilazione sia avvenuta con successo.} \break %TODO: quei o quegli?
...
%TODO: volendo modificare l'esempio del codice.
\begin{lstlisting}
	#include <iostream>
	#include <vector>
...
\newpage %questo mi serve altrimenti gli elementi dell'enumerate si vedono troppo larghi.
...
\begin{tabular}{|c|c|}
	...
	\textsf{\small più veloce di tuple.} & \textsf{\small se non ottimizzata.} \\ %textsc
	\hline
\end{tabular}
...
\section{Conversion Constructor \& Explicit keyword}  %TODO: lasciarlo qui o spostarlo come subsection da qualche parte?
...
\textsf{\small Se, per esempio, il costruttore richiedesse un \textbf{int} e noi passassimo un \textbf{char}, senza la keyword \textbf{explicit}, il \textbf{char} verrebbe implicitamente convertito in \textbf{int}.} \\
...
\section{Private Destructors} %TODO: mettere questa parte nella sezione con la friend keyword?
