...
\textsf{\small Un \textbf{xvalue} (\emph{eXpring}) riferisce anche ad un oggetto, di solito vicino la fine del suo tempo di vita. Un \textbf{xvalue} è il risultato di certi tipi di espressioni riguardanti le referenze \textbf{rvalues}.} \\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.2\textwidth, height=1.2\textheight, keepaspectratio]{./imgs/values_categories2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.2\textwidth, height=1.2\textheight, keepaspectratio]{./imgs/value_categories.png}
