...
\newcommand*{\titleGM}{\begingroup% Gentle Madness
	...
	\hbox{%
		...
		\parbox[b]{0.75\textwidth}{
			\vbox{%
				\vspace{\drop} %TODO: Rename into "Una semplice guida al C++ Moderno" o simile %TODO: Prima era "A Simple Guide to\\ Modern C++"
				{\noindent\HUGE\bfseries A Simple Guide to\\ Modern C++}\\[2\baselineskip]
				{\Large\itshape Beginner}\\[0.5\baselineskip] %TODO: Principiante
				{\Large\itshape Intermediate}\\[0.5\baselineskip] %TODO: Intermedio
				{\Large\itshape Advanced}\\[4\baselineskip] %TODO: Avanzato
				{\Large Luca Rengo}\par
				\vspace{0.5\textheight}
				{\noindent Novembre 2023 v1.1.1}\\[\baselineskip]
			}% end of vbox
		}% end of parbox
	}% end of hbox
	\vfill
...
\begin{document}
	...
	\include{Convenzioni_del_Linguaggio}
